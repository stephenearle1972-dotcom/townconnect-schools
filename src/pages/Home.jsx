        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
          {home.pillars.map((p) => (
            <div key={p.title} className="card-classy rounded-3xl p-8">
              ...
              <h3 className="mt-4 text-2xl font-serif font-bold text-forest italic">
                {p.title}
              </h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-forest italic">
