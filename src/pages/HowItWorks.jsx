      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 animate-fade">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 sm:gap-8">
          {howItWorks.steps.map((step) => (
            <div key={step.number} className="card-classy rounded-3xl p-8">
              <p className="font-serif italic text-clay text-5xl">{step.number}</p>
              <h3 className="mt-4 text-2xl font-serif font-bold text-forest">
                {step.title}
              </h3>
        ...
        <div className="mt-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl font-serif font-bold text-forest italic">
