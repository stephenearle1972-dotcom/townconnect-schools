  ...
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 animate-fade">
      ...
      <div className="mt-10 flex flex-col items-center">
        <a
          href="https://wa.me/27791866145?text=Hi"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-white font-bold text-lg shadow-lg hover:opacity-90 transition-opacity"
        ...
        <p className="mt-3 text-sm text-gray-500 italic">
          Or use the chat below to try it in your browser
        </p>
      </div>
