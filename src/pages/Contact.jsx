      ...
      <div className="mt-12 grid md:grid-cols-3 gap-8">
        ...
        <aside className="space-y-6">
          <div className="card-classy rounded-3xl p-6">
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-clay">
              Email
            </p>
            <a
              href={`mailto:${brand.contactEmail}`}
              className="block mt-3 text-forest font-serif italic text-lg break-all hover:text-clay transition-colors"
            >
              {brand.contactEmail}
            </a>
          </div>
          <div className="card-classy rounded-3xl p-6">
            ...
            <a
              ...
              className="block mt-3 text-forest font-serif italic text-lg hover:text-[#25D366] transition-colors"
            >
              {brand.contactPhone}
            </a>
          </div>
          <div className="card-classy rounded-3xl p-6 bg-gradient-to-br from-white to-sand/40">
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-clay">
              {brand.parent} family
            </p>
