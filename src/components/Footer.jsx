...
export default function Footer() {
  return (
    <footer className="bg-forest text-sand py-20 mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="md:col-span-2">
            ...
            <div className="mt-8 space-y-3">
              <p className="text-[10px] font-black uppercase tracking-widest text-clay">
                Get in touch
              </p>
              <a
                href={`mailto:${brand.contactEmail}`}
                className="flex items-center gap-2 text-sm text-white hover:text-clay transition-colors"
              >
